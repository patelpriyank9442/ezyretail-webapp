...
export default function FilterCard() {
    const { productDetail, productFilter } = useSelector((state) => state.product)
    ...
    const addToCartHandler = (productId, categoryId) => {
    ...
    return (
        <>
            ...
            {(productFilter?.length > 0 ? productFilter : productDetail)?.map((item) => {
                return (
                        ...
                        <div className="lg:p-[17px]">
                            <div>
                                ...
                                <div className='md:mt-[25px] mt-[18px] flex items-baseline gap-2.5'>
                                    <p className='text-gray-300 md:text-[25px] text-base font-semibold md:leading-[31px] leading-[20px]'>${item.price}</p>
                                    <p className='text-gray-200 md:text-[15px] text-sm font-normal md:leading-[18px] leading-[17px] discountLine'>${item.price}</p>
                                </div>
                            </div>
